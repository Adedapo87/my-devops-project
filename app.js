...
<html>
<head>
  <title>Adedapo DevOps 2025</title>
  <style>
    body { font-family: Lora, sans-serif; max-width: 800px; margin: 50px auto; padding: 20px; }
...
<body>
  <div class="header">
    <h1>Adedapo DevOps 2025</h1>
    <p>Modern Node.js application with CI/CD pipeline</p>
  </div>
  <h2>Available Endpoints:</h2>
  <div class="endpoint"><strong>GET /</strong> - Adedapo welcome page</div>
